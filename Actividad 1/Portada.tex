...
\begin{center}
    ...
    {\Large Migueles Martinez Lino Shatini - 320178643} \\[1cm]
    ...
    {\LARGE \textbf{Actividad 1}}\\[0.5cm]

    {\LARGE {¿Cuáles son las diferencias entre la seguridad de la información y ciberseguridad?}}\\[1cm]


    {\Large \textbf{Fecha de Entrega:}}\\[0.2cm]
    {\Large 22 de Agosto del 2027}
\end{center}